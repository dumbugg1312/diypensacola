// Vendored third-party file. Do not hand-edit.
//
//   upstream: https://gc.zgo.at/count.js   (GoatCounter's own tracking script)
//   project:  https://github.com/arp242/goatcounter
//   license:  ISC (see the header below, which is upstream's)
//   fetched:  2026-08-23
//   sha256:   792b7abd26c1fb6ae62906833e09a301251e2641816e69e4f95aba518f3fe3f0
//
// Served from our OWN origin as /count.js rather than linked from gc.zgo.at, so
// the site-wide `script-src 'self'` never has to admit a third-party script
// host. build.py copies this file verbatim into the site root; the only edit is
// this provenance block. To update: re-fetch the upstream URL, re-record the
// sha256 above, and re-read the diff before committing (this file runs on every
// page of the site).
